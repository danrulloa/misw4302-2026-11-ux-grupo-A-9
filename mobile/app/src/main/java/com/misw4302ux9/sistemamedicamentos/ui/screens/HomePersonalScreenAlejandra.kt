...
@Composable
fun HomePersonalScreenAlejandra(
    onBackClick: () -> Unit,
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                if (selectedTabIndex == 0) {
                    AppSwitchListItem(
                        headline = "Ibuprofeno",
                        supportingText = "2:00 PM (Cada 8 horas)",
...
@Composable
fun HomePersonalScreenAlejandraPreview() {
    SistemaMedicamentosTheme {
        HomePersonalScreenAlejandra(onBackClick = {}, onNavigateToHistorial = {}, onNavigateToCrearAlarma = {})
    }
}
