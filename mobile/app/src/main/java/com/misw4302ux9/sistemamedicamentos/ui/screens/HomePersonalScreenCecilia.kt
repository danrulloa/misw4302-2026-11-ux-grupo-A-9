        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                if (selectedTabIndex == 0) {
                    AppSwitchListItem(
                        headline = "Enalapril",
                        supportingText = "8:00 AM (Cada 24 horas)",
                    ...
                    AppSwitchListItem(
                        headline = "Atorvastatina",
                        supportingText = "9:00 PM (Cada noche)",
                    ...
                    AppSwitchListItem(
                        headline = "Calcio + Vitamina D",
                        supportingText = "10:00 AM (Cada día)",
...
@Composable
fun HomePersonalScreenCeciliaPreview() {
    SistemaMedicamentosTheme {
        HomePersonalScreenCecilia(onBackClick = {}, onNavigateToHistorial = {}, onNavigateToCrearAlarma = {})
    }
}
